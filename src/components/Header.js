  ...
  return (
    <header>
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <div className="text-white flex items-center text-xs space-x-6 text-justify mx-6 whitespace-nowrap">
          <div className="link">
            <p>Hello Sonny Sagha</p>
          ...
          <div className="relative link flex items-center">
            ...
            <span className="absolute bg-yellow-400 font-bold top-0 right-0 md:right-11 h-4 w-4 text-center rounded-full text-black ">
              0
            </span>
            <p className="hidden md:inline mt-3 font-extrabold md:text-sm ">
              Basket
            </p>
          </div>
        </div>
